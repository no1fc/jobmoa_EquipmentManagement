...
국민���업지원제도 지점에서 근무하는 상담사들이 IT 장비, 사무용 가구, 소모품 등을 직관적으��� 관리할 수 있도록 돕는 통합 장비/자산 관리 플랫폼입니다.

## 주요 기능

- **AI 장비 등록**: 모바일 카메라로 장비 촬영 시 온디바이스 AI(Gemma 4 E2B)가 장비를 자동 분류
- **장비 관리**: 장비 등록, 조회, 수정, 상태 관리 (사용중/대여중/고장/폐���)
- **대여 관리**: 장비 대여/반납 처리, 대여 현황 대시보드, 반납 알림
